...
Event.register(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'/nanum/site/board/nninc_photo_mobile/img/lt_loading.gif',
		expandimg:'/nanum/site/board/nninc_photo_mobile/img/lt_expand.gif',
		shrinkimg:'/nanum/site/board/nninc_photo_mobile/img/lt_shrink.gif',
		previmg:'/nanum/site/board/nninc_photo_mobile/img/lt_prev.gif',
		nextimg:'/nanum/site/board/nninc_photo_mobile/img/lt_next.gif',
		effectimg:'/nanum/site/board/nninc_photo_mobile/img/lt_zzoop.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'effectable',
		closeimg:'/nanum/site/board/nninc_photo_mobile/img/lt_close.gif',
		resizable:true
	});
});
