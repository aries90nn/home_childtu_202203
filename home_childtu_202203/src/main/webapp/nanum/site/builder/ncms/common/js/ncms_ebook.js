...
function w_chk(){
	...
	if (CheckSpaces(document.getElementById('frm').eb_subject, '제목')) { return false; }
...
function win_popup(eb_pk,vscrollbars,vtoolbar,vmenubar,vlocation,vwidth,vheight){		
	window.open('/ebook/index.do?eb_size=max&eb_pk='+eb_pk,'','scrollbars='+vscrollbars+',toolbar='+vtoolbar+',menubar='+vmenubar+',location='+vlocation+',width='+vwidth+',height='+vheight+',location=no');
}
