...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("/nanum/site/ebook/skin4/ebook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "/nanum/site/ebook/skin4/js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#" + this.settings.backgroundColor.toString( 16 ) });
}
