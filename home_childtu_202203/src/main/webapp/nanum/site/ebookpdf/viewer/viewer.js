...
//    appConfig.secondaryToolbar.downloadButton.setAttribute('display', 'true');
  };
}
...
var defaultOptions = {
  ...
  workerSrc: {
    value: '/nanum/site/ebookpdf/viewer/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.locale = {
    value: typeof navigator !== 'undefined' ? navigator.language : 'kor',
    kind: OptionKind.VIEWER
  };
}
...
function () {
  ...
  _createClass(Toolbar, [{
    ...
    value: function _bindListeners() {
	  ...
	  //IE일때
      items.pageNumber.addEventListener('keyup', function (key) {
		 var agent = navigator.userAgent.toLowerCase();
