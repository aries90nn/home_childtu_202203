...
<html dir="ltr" mozdisallowselectionprint>
  ...
  <body tabindex="1" class="loadingInProgress" oncontextmenu='return false' ondragstart='return false'>
	<input type="hidden" id="filename" value="/data/ebookpdf/2020011094843848943761.pdf" />
...
<!-- turn.min.js, zoom.min.js, magazine.js -->
      <script src="./turnjs4/turn.min.js"></script>
      <script src="./turnjs4/zoom.min.js"></script>
