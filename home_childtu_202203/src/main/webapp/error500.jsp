...
<div style="text-align:center;font-family:돋움;padding-top:8%;">
	<p style="color:#2654c7;font-weight:bold;font-size:40px;margin-bottom:35px;">500 error</p>
	<p style="color:#000;font-weight:bold;font-size:13px;margin-bottom:15px;">일시적 오류가 발생했습니다.</p>
	<p style="color:#333;font-weight:normal;font-size:13px;margin-bottom:10px;">서비스 이용에 불편을 끼쳐드려 죄송합니다.<br />메인 페이지로 이동후 다시 이용해 주시길 바랍니다.</p>
