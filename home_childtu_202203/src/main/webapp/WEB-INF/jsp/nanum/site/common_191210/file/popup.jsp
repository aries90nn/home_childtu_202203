	...
	<div id='layer_${popup.idx}' class="mmimg_w" style='position:absolute; left:${popup.w_left}px; top:${popup.w_top}px; z-index:999;background-color:#FFFFFF;white-space:normal;border:1px solid #CCCCCC;display:none' class="mobile_pop_style${no.count}">
		...
		<div class="popup" style="margin-top:10px">
			<div class="popup_right">
				<ul>
				<li><input type="checkbox" id="next_close${popup.idx}" value="Y" /></li>
				<li class="pt5 pr10"><label for="next_close${popup.idx}">다음에 창 열지 않기</label></li>
				<li class="button pr5"><input type="button" value="닫기" onclick="closeWin${popup.idx}();" class="ct_bt01" style="border:1px solid #000;font-size:12px;background:#fff;" /></li>
				</ul>
			</div>
		</div>
		</c:if>
