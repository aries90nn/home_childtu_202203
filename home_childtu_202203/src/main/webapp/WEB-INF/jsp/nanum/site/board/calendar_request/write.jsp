...
<script type="text/javascript">//<![CDATA[
	...
	function w_chk(){
		...
		if (CheckSpaces(document.getElementById('frm').b_subject, '기관명')) {return false;}
		...
		else if (CheckSpaces(eForm.b_temp1, "방문인원")) {return false;}
	...
	<div class="table_bwrite">	
			...
			<thead>
				<tr>
					...
					${fn:substring(board.b_sdate, 0, 4)}년 ${fn:substring(board.b_sdate, 5, 7)}월 ${fn:substring(board.b_sdate, 8,10)}일 신청</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<th scope="row"><label for="b_subject"><img alt="*(필수항목)" src="/nanum/site/board/nninc_simple/img/ic_vcheck.gif"/> 신청기관명</label></th>
				...
				<tr>
					<th scope="row"><img alt="*(필수항목)" src="/nanum/site/board/nninc_calendar/img/ic_vcheck.gif"/> <label for="b_temp1">방문인원</label></th>
					<td style="padding-top:5px;padding-bottom:5px;">
						<c:set var="max_inwon" value="30" />
						
						<span class="select_style">
						<select id="b_temp1" name="b_temp1">
							<option value="">인원선택</option>
							<c:forEach var="i" begin="1" end="${max_inwon}" step="1">
							<option value="${i}" ${board.b_temp1 eq i ? "selected" : ""}>${i}명</option>
							</c:forEach>
						</select>
						</span>
				...
				<tr>
					<th scope="row"><label for="b_temp2"><img alt="*(필수항목)" src="/nanum/site/board/nninc_calendar/img/ic_vcheck.gif"/> 방문시간대</label></th>
					<td>
