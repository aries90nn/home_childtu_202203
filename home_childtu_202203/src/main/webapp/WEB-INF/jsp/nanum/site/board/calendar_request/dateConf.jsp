...
<head>
	...
	<title>일별신청설정 | ${BUILDER.bs_sitename }</title>
...
<div id="board" style="width:100%;">
	...
	<div class="guide" style="font-size:13px;">
		<span><img src="/nanum/site/board/${config.a_level}/img/ic_vcheck.gif" width="7" height="10" alt="*" /> 해당날짜에 신청받을 인원를 입력하세요.</span>
	</div>

	<div  class="table_bwrite"> 
		<!-- 게시판상단e -->
		<table class="table4" summary="신청하기">
			<caption>
				일자별 신청정보 설정
			</caption>
			<colgroup>
			...
			<tbody>
				<tr>
					<th>분류 </th>
					<td class="end">
<c:set var="a_bbsname_arr" value="${fn:split(config.a_bbsname, '>') }" />
<c:set var="title" value="${a_bbsname_arr[fn:length(a_bbsname_arr)-1] }" />
						${title } 일자별 설정
					</td>
				</tr>
				<tr>
