...
<style>
.board_input {border:1px solid #cdcdcd; height: 30px; padding:3px; font-size: 16px; background:#fff;}
</style>
...
<div id="board" style="width:${config.a_width};">
	...
	<div class="table_bwrite">
			...
			<tbody>
				...
				<tr>
					<th scope="row"><label for="b_subject"><img alt="*(필수항목)" src="/nanum/site/board/nninc_simple/img/ic_vcheck.gif"/>감추기여부</label></th>
					<td>
					<select name="b_temp10" id="b_temp10" class="board_input subject">
						<option value="N" selected>감추기</option>
						<option value="Y" ${board.b_temp10 eq 'Y' ? 'selected' : '' }>보이기</option>
					</select>
					<span class="text1">* 감춰진 게시물은 관리자만 확인 가능합니다.</span>
					</td>
				</tr>
				</c:if>
