...
<link href="/nanum/site/ebook/skin1/css/common.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="/nanum/site/ebook/skin1/js/liquid.js"></script>
<script type="text/javascript" src="/nanum/site/ebook/skin1/js/swfobject.js"></script>
<script type="text/javascript" src="/nanum/site/ebook/skin1/js/ebook.js"></script>
...
<script type="text/javascript">
	...
	flippingBook.settings.flipSound = "/nanum/site/ebook/skin1/sounds/01.mp3";
...
<div>
	...
	<div id="fbFooter">
		...
		<div id="fbMenu">
			<img src="/nanum/site/ebook/skin1/img/btnPrevious.gif" width="31" height="33" border="0" id="fbBackButton" alt="이전페이지" /><img src="/nanum/site/ebook/skin1/img/btnNext.gif" width="31" height="33" border="0" id="fbForwardButton" alt="다음페이지" />
			<img src="/nanum/site/ebook/skin1/img/btnDiv.gif" width="7" height="33" border="0" class="div" alt="" />
			<img src="/nanum/site/ebook/skin1/img/btnZoom.gif" width="31" height="33" border="0" id="fbZoomButton" alt="확대/축소" /><img src="/nanum/site/ebook/skin1/img/btnPrint.gif" width="31" height="33" border="0" id="fbPrintButton" alt="인쇄" /><img src="/nanum/site/ebook/skin1/img/btnHelp.gif" width="31" height="33" border="0" id="fbHelpButton" alt="이용방법" onclick="window.open('/nanum/site/ebook/skin1/help.html','help','width=392,height=593');" style="cursor:pointer;" />

			<img src="/nanum/site/ebook/skin1/img/btnDiv.gif" width="7" height="33" border="0" class="div" alt="" />
			<img src="/nanum/site/ebook/skin1/img/btnMax.gif" width="21" height="33" border="0" alt="최대화" onclick="ebook_size();" style="cursor:pointer;" /><img src="/nanum/site/ebook/skin1/img/btnClose.gif" width="21" height="33" border="0" alt="닫기" onclick="window.close();" style="cursor:pointer;" />
		</div>
		...
		<div id="fbContents2">
			<ul>
				...
				<li style="padding-left:3px;"><input type="image" src="/nanum/site/ebook/skin1/img/btnSearch.gif" alt="검색" /></li>
				<li style="padding-left:4px;"><a href="javascript:;" onclick="ebook_go1('/nanum/site/ebook/index.do?eb_pk=${ebook.eb_pk}');"><img src="/nanum/site/ebook/skin1/img/btnTotalview.gif" alt="전체보기" /></a></li>
				<li style="padding-left:5px;"><img src="/nanum/site/ebook/skin1/img/btnDiv2.gif" width="7" height="22" border="0" class="div" alt="" /></li>
			</ul>
		</div>
