...
<div id="board" style="width:${config.a_width};">
	...
	<div class="guide">
		<span><img src="/nanum/site/board/nninc_faq/img/ic_vcheck.gif" alt="*(필수항목)" /> 표시가 된 곳은 필수 항목입니다.</span>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<input type="radio" id="b_noticechk_N" name="b_noticechk" value="" ${board.b_noticechk == "" ? "checked" : ""} /><label for="b_noticechk_N">사용안함</label>
					</td>
				</tr>
				</c:if>
				<!-- 공지사항 게시기간 설정 -->
