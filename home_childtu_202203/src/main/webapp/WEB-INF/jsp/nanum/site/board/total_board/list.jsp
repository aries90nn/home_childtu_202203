...
<div id="board" style="width:${config.a_width};">
	...
	<tbody>
		...
		<tr>
			...
			<td class="notice title" style="${no_board.txt_title_style}">
				...
				<a href="?proc_type=view&a_num=${config.a_num}&b_num=${no_board.b_num}&prepage=${nowPageEncode}">${no_board.b_subject}</a>
	...
	<tr>
		...
		<td class="title" style="${board.txt_title_style}">${lib_title }
				${board.txt_show}
