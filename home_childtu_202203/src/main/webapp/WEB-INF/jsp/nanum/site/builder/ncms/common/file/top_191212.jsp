...
<div id="head_wrap">
	<div class="head_wrap_default">
		...
		<ul id="top_area">
<c:set var="first_menu_url" value="/${BUILDER_DIR }/ncms/edusat/list.do" />
<c:if test="${BUILDER_DIR eq 'marathon' }">
	<c:set var="first_menu_url" value="/${BUILDER_DIR }/ncms/site/marathon/req_list.do" />
</c:if>
