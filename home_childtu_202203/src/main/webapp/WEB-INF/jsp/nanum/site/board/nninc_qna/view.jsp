	...
	<div class="table_bview">
		...
		<tbody>
			...
			<tr>
				...
				<td><strong>${board.b_re_state}</strong></td>
			</tr>
			<tr>
				<th scope="row">내용</th>
...
<div class="board_button">
		...
		<span><a href="?proc_type=reply&a_num=${config.a_num}&b_num=${board.b_num}&prepage=${nowPageEncode}" class="cbtn cbtn_g">답변</a></span>
		</c:if>
