		...
		<tbody>
			...
			<tr>
				<td colspan="3" class="content">
					<c:forEach var="t" begin="2" end="5" step="1">
						<c:set var="b_file">b_file${t}</c:set>
						<c:set var="file_name">${board[b_file]}</c:set>
					...
					<c:if test="${!empty board.b_temp1}">
						<iframe height="500" width="80%" src="https://www.youtube.com/embed/${board.b_temp1}" title="${board.b_subject }" frameborder="0" allowfullscreen></iframe>
					</c:if>
