...
<div class="guide">
	<span><img height="10" width="7" alt="*" src="/nanum/site/edusat/img/ic_vcheck.gif"/> 강좌신청시 등록한 정보를 입력하세요.</span>
</div>
...
<!-- 신청자 확인 -->
<form name="frm" method="post" action="" onsubmit="return cancelGo(this);">
	...
	<div class="table_bwrite">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" name="es_name" id="es_name" style="width:100px" class="board_input" onfocus="focus_on1(this);" onblur="focus_off1(this);" value="${param.es_name}" maxlength="20" /></td>
			</tr>
			<!-- <tr>
			...
			<tr>
				...
				<td>
					<input type="text" size="7" title="휴대폰 식별번호(첫번째자리)" id="es_bphone1" name="es_bphone1" class="board_input" onfocus="focus_on1(this);" onblur="SetNum(this);focus_off1(this);" value="${param.es_bphone1}" maxlength="4" />
					- <input type="text" size="7" title="휴대폰 국번입력(가운데자리)" id="es_bphone2" name="es_bphone2" class="board_input" onfocus="focus_on1(this);" onblur="SetNum(this);focus_off1(this);" value="${param.es_bphone2}" maxlength="4" />
					- <input type="text" size="7" title="휴대폰 개별번호(마지막자리)" id="es_bphone3" name="es_bphone3" class="board_input" onfocus="focus_on1(this);" onblur="SetNum(this);focus_off1(this);" value="${param.es_bphone3}" maxlength="4" />
				</td>
			</tr>
			
			<tr>
				<th scope="row"><img height="10" width="7" alt="*" src="/nanum/site/edusat/img/ic_vcheck.gif"/> <label for="es_name">비밀번호</label></th>
				<td><input type="password" name="es_pwd" id="es_pwd" style="width:200px" class="board_input" onfocus="focus_on1(this);" onblur="focus_off1(this);" value="" maxlength="20" size="20" /></td>
			</tr>
		</tbody>
		</table>
		...
		<!-- 버튼 -->
		<div class="btn_w">
			<span><input type="submit" value="확인" class="con_btn orange" /></span>
			<span><input type="button" value="되돌아가기" class="con_btn blue" onclick="location.href='${prepage}';" /></span>
		</div>
		<!-- //버튼 -->
	</div>
</form>
