	...
	<div class="table_blist">
			...
			<tbody>
				...
				<tr>
					...
					<td>${b_name}</td>
					<td>
						<c:if test="${board.b_re_date ne ''}">
							${fn:replace(fn:substring(board.b_re_date,0,10),"-", ".")}
						</c:if>
					</td>
					<td><span style="font-weight:bold;font-size:0.9em;">${board.b_re_state == "" ? "접수" : board.b_re_state}</span></td>
					<td>${board.b_count}</td>
				</tr>
			</c:forEach>
