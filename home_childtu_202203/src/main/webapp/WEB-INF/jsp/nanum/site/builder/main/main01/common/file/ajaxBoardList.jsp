...
<script>
	$(document).ready(function(){
		...
		var idx2=$('.main_noticewrap ul li.box > div.lib2').parent().css("border-bottom","solid 3px #55d091");
		var idx3=$('.main_noticewrap ul li.box > div.lib3').parent().css("border-bottom","solid 3px #509bea");
		var idx4=$('.main_noticewrap ul li.box > div.lib4').parent().css("border-bottom","solid 3px #7564f2");
