	...
	<div class="table_bview">
		...
		<thead>
				<tr>
					...
					${fn:substring(board.b_sdate, 0, 4)}년 ${fn:substring(board.b_sdate, 5, 7)}월 ${fn:substring(board.b_sdate, 8,10)}일 자원봉사신청정보</th>
				</tr>
		</thead>
		<tbody>
...
<c:if test="${is_ad_cms eq 'Y'}">
				<tr>
					...
					<td>
						...
						<c:if test="${!empty board.b_temp6 }">
							( ${nowYear- fn:substring(board.b_temp6,0,4) + 1 }세 )
						</c:if>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th scope="row">성별</th>
					<td>
						${board.b_temp1 eq '0' ? '남' : '여' }
					</td>
				</tr>
</c:if>
				<tr>
					<th scope="row">희망시간대</th>
					<td>
						${board.b_temp2}
					</td>
				</tr>
				<tr>
					<th scope="row">봉사활동시간</th>
					<td>
						${board.b_temp5}
					</td>
				</tr>
