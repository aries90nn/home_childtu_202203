...
<head>
	...
	<title>관리자페이지 : 담당자업무관리 (순서변경) </title>
	<!-- css, script-->
...
<style>
.sortable li {height:35px;}
</style>

<h1 class="tit"><span>${ct_name} 직원</span> 순서 일괄수정</h1>

	
<form id= "frm_list" action="/${BUILDER_DIR}/ncms/buseo_member/listMoveOk.do" method="post" onsubmit="return check_submit();">
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${member.m_name}
				</p>
				...
				<input type="hidden" name="chk" value="${member.m_num}" />
			</li>
			</c:forEach>
