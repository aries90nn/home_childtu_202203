...
<h1 class="tit"><span>요일별</span> 통계</h1>
<!-- 내용들어가는곳 -->
<div id="contents_area">
	
	<form id="frm" action="w.do" method="get">
	<!-- 검색 -->
<div class="top_search_area mt10">
	<ul>
		<li class="tit"><label for="YY"><h3 class="tit">요일별검색 :</h3></label></li>
		<li class="sel">
			<!-- 현재날짜 -->
		...
		<li class="btn"><input type="button" value="이번달" class="btn_gr_default" onclick="page_go1('w.do?yy=${currentYear}&mm=${currentMon}');" /></li>
	</ul>
</div>
<!-- //검색 -->
</form>
...
<tbody>
<c:forEach var="z" begin="1" end="7" step="1">
<tr>
	<td>${arrData[z][3]}</td>
<td>${arrData[z][0]}</td>
</tr>
...
<!-- //챠트 -->
			...
			<div class="list_count mt10 mb5">
				...
				<fieldset>
					...
					<table class="bbs_common bbs_default" summary="요일별 방문자를 확인합니다.">
					...
					<c:forEach var="z" begin="1" end="7" step="1">
					<tr>
						<td class="center">${arrData[z][3]}</td>
