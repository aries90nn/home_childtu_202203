...
<div>
	...
	<div class="popup">
		<div class="popup_btm">
			<div class="btn_chk"><input type="checkbox" id="next_close" value="Y" /><label for="next_close">다음에 창 열지 않기</label></div>
			<input type="button" value="닫기" onclick="closeWin();" class="btn_cls" />
		</div>
	</div>
	</c:if>
