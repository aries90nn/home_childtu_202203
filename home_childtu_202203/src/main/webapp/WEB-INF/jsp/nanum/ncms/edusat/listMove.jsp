...
<head>
	...
	<title>관리자페이지 : 독서문화프로그램관리 (순서변경) </title>
	<!-- css, script-->
...
<style>
.sortable li {height:65px;}
</style>

<h1 class="tit"><span>문화행사</span> 순서 일괄수정</h1>

	
<form id= "frm_list" action="/ncms/edusat/listMoveOk.do" method="post" onsubmit="return check_submit();">

<div class="section_card">

	<ul class="sortable" id="sortable">

			<c:forEach items="${edusatList}" var="edusatList" varStatus="no">
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${edusatList.edu_subject}
					</br >접수기간 : ${edusatList.edu_resdate} ~ ${edusatList.edu_reedate}
					</br >문화행사기간 : ${edusatList.edu_sdate} ~ ${edusatList.edu_edate}
					</p>
				...
				<input type="hidden" name="chk" value="${edusatList.edu_idx}" />
			</li>
			</c:forEach>
