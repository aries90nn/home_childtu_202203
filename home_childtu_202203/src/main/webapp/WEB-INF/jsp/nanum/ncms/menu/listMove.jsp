...
<h1 class="tit"><span>메뉴</span> 순서 일괄수정</h1>

	
<form id= "frm_list" action="/ncms/menu/listMoveOk.do" method="post" onsubmit="return check_submit();">
<input type="hidden" id="ct_ref" name="ct_ref" value="${ct_ref}" />
<input type="hidden" id="prepage" name="prepage" value="${param.prepage}" />
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${menuList.ct_name}</br>
				...
				<input type="hidden" name="chk" value="${menuList.ct_idx}" />
			</li>
			</c:forEach>
