...
<h1 class="tit"><span>이북</span> 순서 일괄수정</h1>

	
<form id= "frm_list" action="/ncms/ebook/listMoveOk.do" method="post" onsubmit="return check_submit();">
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style='width:100%;'>
					<strong class="jsNum">${no.count}</strong>. ${ebookList.eb_subject} ${ebookList.eb_chk == "Y" ? "<strong>(사용)</strong>" : "(중지)"}
				...
				<input type="hidden" name="chk" value="${ebookList.eb_idx}" />
			</li>
			</c:forEach>
