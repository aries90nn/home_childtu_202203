...
<head>
	...
	<title>관리자페이지 : 회원그룹관리 (순서변경) </title>
	<!-- css, script-->
...
<h1 class="tit"><span>회원그룹관리</span> 순서 일괄수정</h1>
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${memberGroup.g_menuname}
				</p>
				...
				<input type="hidden" name="chk" value="${memberGroup.g_num}" />
			</li>
			</c:forEach>
