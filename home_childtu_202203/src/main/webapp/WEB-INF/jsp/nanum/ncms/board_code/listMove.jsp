...
<head>
	...
	<title>관리자페이지 : 게시판분류관리 (순서변경) </title>
	<!-- css, script-->
...
<h1 class="tit"><span>게시판 분류(${a_bbsname})</span> <br/>순서 일괄수정</h1>
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${boardcode.ct_name}
				</p>
				...
				<input type="hidden" name="chk" value="${boardcode.ct_idx}" />
			</li>
			</c:forEach>
