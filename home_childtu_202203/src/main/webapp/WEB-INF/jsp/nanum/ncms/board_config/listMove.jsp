...
<style>
.sortable li {height:45px;}
</style>

<h1 class="tit"><span>게시판</span> 순서 일괄수정</h1>
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${board.a_tablename}</br>
					${board.a_bbsname}
				</p>
				...
				<input type="hidden" name="chk" value="${board.a_num}" />
			</li>
			</c:forEach>
