...
<h1 class="tit"><span>간행물</span> 순서 일괄수정</h1>
...
<input type="hidden" name="eb_code" value="${ebookList.eb_code }" />
</c:forEach>
...
<div class="section_card">
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				...
				<input type="hidden" name="idx" value="${ebookList.eb_idx}" />
			</li>
			</c:forEach>
