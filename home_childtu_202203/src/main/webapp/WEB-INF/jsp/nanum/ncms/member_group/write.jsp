...
<c:forEach items="${membergroupList}" var="membergroup" varStatus="no">
			<tr>
				...
				<td class="left">
					<c:choose>
						<c:when test="${!empty BUILDER_DIR and (membergroup.g_num eq '1' or membergroup.g_num eq '2' or membergroup.g_num eq '3' or membergroup.g_num eq '4')}">
				...
				<td class="center" style="padding-left:10px;">
					<c:choose>
						...
						<c:otherwise>
							<a href="javascript: frm_modify${no.count}(${membergroup.g_num});"><img value="수정" src="/nanum/ncms/img/common/modify_icon.gif" /></a>
