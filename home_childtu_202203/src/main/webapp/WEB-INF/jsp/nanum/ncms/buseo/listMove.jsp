...
<h1 class="tit"><span>부서</span> 순서 일괄수정</h1>

	
<form id= "frm_list" action="/${BUILDER_DIR}/ncms/buseo/listMoveOk.do" method="post" onsubmit="return check_submit();">
	...
	<ul class="sortable" id="sortable">
			...
			<li>
				<p class="text" style="width:100%;">
					<strong class="jsNum">${no.count}</strong>. ${buseo.ct_name}
				</p>
				...
				<input type="hidden" name="chk" value="${buseo.ct_idx}" />
			</li>
			</c:forEach>
