...
<%
    ...
    //String sSiteCode = "G7048";			// NICE로부터 부여받은 사이트 코드
    //String sSitePassword = "ZS6ZT29YXOFY";		// NICE로부터 부여받은 사이트 패스워드
    ...
    String sReturnUrl = domain+"/cert/nice/mobile/checkplus_success.jsp?prepage="+java.net.URLEncoder.encode(prepage,"UTF-8");      // 성공시 이동될 URL
    String sErrorUrl = domain+"/cert/nic/mobile/checkplus_fail.jsp";          // 실패시 이동될 URL
