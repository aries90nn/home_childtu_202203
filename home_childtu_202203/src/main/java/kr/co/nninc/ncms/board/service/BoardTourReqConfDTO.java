...
@Repository("tourreqconfdto")
public class BoardTourReqConfDTO extends ExtendDTO implements Serializable {
	private static final long serialVersionUID = -4120857143718511662L;
