package kr.co.nninc.ncms.banner.service;
...
@Repository("bannerdto")
public class BannerDTO extends ExtendDTO implements Serializable{

	private static final long serialVersionUID = -6962881073019161172L;
