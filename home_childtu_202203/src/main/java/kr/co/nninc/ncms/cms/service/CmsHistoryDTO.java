...
@Repository("cmshistorydto")
public class CmsHistoryDTO extends ExtendDTO  implements Serializable{

	private static final long serialVersionUID = -4778692482158555860L;

	private String cth_idx;
	...
	private String ct_mobile_menu_url;
	private String m_id;
	private String ct_board_header;
	private String ct_board_footer;
	private String ct_group;
	
	public String getCth_idx() {
		return cth_idx;
	}
	public void setCth_idx(String cth_idx) {
		this.cth_idx = cth_idx;
	}
	...
	public String getCt_mobile_menu_url() {
		return ct_mobile_menu_url;
	}
	public void setCt_mobile_menu_url(String ct_mobile_menu_url) {
		this.ct_mobile_menu_url = ct_mobile_menu_url;
	}
